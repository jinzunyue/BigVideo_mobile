...
public class FullMediaControl {
    ...
    public FullMediaControl(Context context, VideoView videoView) {
        ...
        mContext = context;
        mRootView = View.inflate(context, R.layout.custom_media_control, null);
    ...
    private void initView() {
        ...
        mQuick = (ImageView) mRootView.findViewById(R.id.iv_quick);
        mCurrentTime = (TextView) mRootView.findViewById(R.id.tv_start);
        mEndTime = (TextView) mRootView.findViewById(R.id.tv_end);
        mType = (TextView) mRootView.findViewById(R.id.tv_type);
        mSelect = (TextView) mRootView.findViewById(R.id.tv_select);
